...
const Header = () => {
    ...
    return (
        <header className='font-thin gap-2 sm:grid grid-cols-[1fr,1fr]   border-b-2  justify-center    md:grid-cols-[10rem,10rem,10rem,10rem,10rem]  gap-2 text-md lg:text-2xl m-6'>
